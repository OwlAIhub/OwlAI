...
import Logo from "@/assets/owlai_main_logo.webp";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <span className="text-2xl font-bold tracking-tight">Owl AI</span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed max-w-md mb-8">
              Your AI-powered learning assistant designed to help you excel in
              competitive exams. Get instant answers, personalized study plans,
              and 24/7 support.
            </p>
