...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Yes! Owl AI provides comprehensive practice tests and mock exams. You can assess your preparation level, identify weak areas, and track your progress over time.",
  },
  {
