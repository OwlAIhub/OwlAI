                ...
                {(message.length > maxLength * 0.8 || isOverLimit) && (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      isOverLimit ? 'text-red-600 border-red-200' : 'text-gray-500 border-gray-200'
                    )}
                  >
          ...
          <div className='flex items-center justify-between mt-2 px-1'>
            ...
            <div className='flex items-center gap-2'>
              <motion.button
                ...
                onClick={() => setMessage('Can you help me with UGC NET preparation?')}
              >
                UGC NET
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className='text-xs text-gray-500 hover:text-primary transition-colors'
                onClick={() => setMessage('Explain research methodology concepts')}
              >
                Research
              </motion.button>
              <motion.button
