...
import { getOnboardingProfile, OnboardingProfile } from '@/lib/services/onboardingService';
                ...
                {onboardingProfile && (
                  <>
                    <div className='flex items-center justify-between'>
                      ...
                      <Badge variant='secondary'>{onboardingProfile.exam}</Badge>
                    </div>
                    <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <Badge variant='outline'>{onboardingProfile.attempt}</Badge>
                    </div>
                    <div className='flex items-center justify-between'>
                      <span className='text-sm text-muted-foreground'>Language</span>
                      <Badge variant='outline'>{onboardingProfile.language}</Badge>
                    </div>
                  </>
                )}
                <Separator />
              ...
              <CardContent className='space-y-4'>
                {onboardingProfile ? (
                  <div className='grid gap-4 md:grid-cols-2'>
                    <div className='space-y-2'>
                      ...
                      <div className='flex items-center gap-2 p-3 bg-gray-50 rounded-md'>
                        ...
                        <span className='font-medium'>{onboardingProfile.exam}</span>
                      </div>
                    </div>
                    <div className='space-y-2'>
                      <Label>Subject</Label>
                      <div className='flex items-center gap-2 p-3 bg-gray-50 rounded-md'>
                        ...
                        <span className='font-medium'>{onboardingProfile.subject}</span>
                      </div>
                    </div>
                    <div className='space-y-2'>
                      ...
                      <div className='flex items-center gap-2 p-3 bg-gray-50 rounded-md'>
                        ...
                        <span className='font-medium'>{onboardingProfile.attempt}</span>
                      </div>
                    </div>
                    <div className='space-y-2'>
                      ...
                      <div className='flex items-center gap-2 p-3 bg-gray-50 rounded-md'>
                        ...
                        <span className='font-medium'>{onboardingProfile.language}</span>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className='text-center py-8'>
                    ...
                    <p className='text-muted-foreground mb-4'>No learning preferences found</p>
                    <Button
                      variant='outline'
