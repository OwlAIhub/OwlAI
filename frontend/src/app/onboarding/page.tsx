...
export default function OnboardingPage() {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      setValidationMessage('Failed to save your preferences. Please try again.');
      setShowValidationPopup(true);
    } finally {
      setLoading(false);
    }
              ...
              >
                <div className='flex items-center justify-between mb-4'>
                  <div className='flex items-center gap-3'>
                    ...
                    <h3 className='text-lg font-semibold text-foreground'>Not Available Yet</h3>
                  </div>
                  <button
                ...
                <div className='flex gap-3'>
                  <Button
                    ...
                    className='flex-1'
                  >
                    {!isExamSupported(data.exam) ? 'Change to UGC-NET' : 'Choose Different Subject'}
                  </Button>
                  <Button
